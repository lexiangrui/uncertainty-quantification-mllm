...
\toprule
\tableheadrow \thead{Dataset} & \thead{Question instances} & \thead{Data and task type} & \thead{Answer type} \\
\midrule
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{不确定性方法评估流程图}
