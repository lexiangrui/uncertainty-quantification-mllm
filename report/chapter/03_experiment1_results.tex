...
The three models produced 6,741 responses in total, of which 6,667 satisfied the XML requirements and entered the formal evaluation, yielding a validity rate of 98.9\%. Cell-level exclusions are reported in Appendix~\ref{subsec:appendix_exclusions}. This high validity rate indicates that format adaptation reliably supports the subsequent correctness, hallucination, and uncertainty analyses. LLaVA has the lowest overall accuracy (0.493) and the highest hallucination rate (0.679), whereas Qwen and InternVL achieve higher accuracy with substantially lower hallucination rates of 0.358 and 0.322, respectively; InternVL has the strongest overall performance.
