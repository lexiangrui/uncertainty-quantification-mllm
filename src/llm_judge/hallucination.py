...
instantiating :class:`QwenMultimodalHallucinationJudge` does.
"""
...
def parse_mmhal_response(text: str) -> dict[str, Any]:
...
class QwenMultimodalHallucinationJudge:
    ...
    def _load(model_path: str, local_files_only: bool):
        try:
            ...
            raise RuntimeError(
                "fp8_kernel is required for QwenMultimodalHallucinationJudge; "
    ...
    def judge(
        ...
        *,
        ...
        messages = build_mmhal_messages(dataset, image, question, str(reference), prediction)
        ...
        result = parse_mmhal_response(response)
